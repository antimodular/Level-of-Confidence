...
public:
    ...
    vector<ofPoint> getMinimumBoundingBox(vector <ofVec2f> _imagePoints);
    ...
    void drawInfoText2(int _language);
    ...
    ofxFTGLFont helveticaCondBoldSmall,helveticaSmall;
    ofxFTGLFont helveticaSmall2;
    //ofTrueTypeFont helveticaCondBoldSmall,helveticaSmall;
    //---------general look
   // ofParameter<ofColor> BGcolor,BGcolor2;
  ...
  //  ofPolyline leftEye_line,rightEye_line;
    
    ofPolyline LEFT_EYE_line;
    ofPolyline RIGHT_EYE_line;
    ofPolyline LEFT_EYEBROW_line;
    ofPolyline RIGHT_EYEBROW_line;
    ofPolyline NOSE_BRIDGE_line;
    ofPolyline NOSE_BASE_line;
    ofPolyline INNER_MOUTH_line;
    ofPolyline OUTER_MOUTH_line;
    ofPolyline JAW_line;
    ...
    //ofParameter<float> livePortrait_ratio;
    float livePortrait_ratio;
   // float old_livePortrait_ratio;
   // ofParameter<int> livePortrait_margin;
   // int old_livePortrait_margin;
   ...
   oneImage pickedImage;
    ...
    int prediction_array[231];
    float avgConfidence_array[231];
    int avgConfidenceCnt_array[231];
