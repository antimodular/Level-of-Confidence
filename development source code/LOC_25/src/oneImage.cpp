...
void oneImage::setup(){
    ...
    ofLog()<<"oneImage setup() dataPath "<<dataPath;
    bigFont.setup("HELVETICALTSTD-COND.ttf"); //, 44, false);
//    bigFont.addFont("HELVETICALTSTD-COND.ttf");
    bigFont.setSize(44);
//        bigFont.loadFont("HELVETICALTSTD-COND.TTF", 44, false);
...
//    ofDrawBitmapString(_first,temp_portraitWidth - (temp0_stringWidth/2.0),bigFont_y);
//    ofDrawBitmapString("mouse"+_first,ofGetMouseX(),ofGetMouseY());
